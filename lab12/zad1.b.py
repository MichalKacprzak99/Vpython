...
ball3_radio_vel=0
ball4_radio_vel=0
ball3=sphere(pos=vector(L2*math.sin(phi2),-L2*math.cos(phi2),0), radius=rad,color=color.blue)
ball4=sphere(pos=vector(L2*(math.sin(phi2)+math.sin(teta2)),-L2*(math.cos(phi2)+math.cos(teta2)),0), radius=rad,color=color.blue)
...
while t<1000:
   ...
   #########################################################3
    ...
    ball3_radio_acc=(-g1/L2*(2*math.sin(phi2)-math.sin(teta2)*math.cos(phi2-teta2))-1/2*ball3_radio_vel*math.sin(2*phi2-2*teta2)-ball4_radio_vel*math.sin(phi2-teta2))/tmp2
    ball4_radio_acc=(-g1/L2*(2*math.sin(teta2)-2*math.sin(phi2)*math.cos(phi2-teta2))+1/2*ball4_radio_vel*math.sin(2*phi2-2*teta2)+2*ball3_radio_vel**2*math.sin(phi2-teta2))/tmp2
    ...
    ball3.pos=vector(L2*math.sin(phi2),-L2*math.cos(phi2),0)
    ball4.pos=vector(L2*(math.sin(phi2)+math.sin(teta2)),-L2*(math.cos(phi2)+math.cos(teta2)),0)
